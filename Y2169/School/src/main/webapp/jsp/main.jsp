...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" background="../images/main_17.gif"><br>
      <table width="95%" border="0" cellspacing="0" cellpadding="0">
      ...
      </table><br>        <table width="95%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td background="../images/desktop_bar_bg.gif"><img src="../images/desktop_bar_left.gif" width="6" height="25" align="absmiddle"><img src="../images/radio_blue.gif" width="13" height="13" align="absmiddle">&nbsp;<font color="#0a66a0"><b>代办事宜</b></font></td>
            <td background="../images/desktop_bar_bg.gif"><div align="right"><img src="../images/desktop_bar_right.gif" width="5" height="25"></div></td>
          </tr>
        </table>        
        <table width="95%" border="0" cellpadding="0" cellspacing="0" class="table_main">
          <tr>
            <td bgcolor="#FFFFFF"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="2%"><img src="../images/item_point.gif" width="4" height="7"></td>
                    <td width="60%" height="20">2008-06-10欧洲足球锦标赛开幕</td>
                    <td><div align="center">云龙</div></td>
                    <td><div align="center">2008-04-13</div></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                <td background="../images/desktop_bar_underline.gif"><img src="../images/desktop_bar_underline.gif" width="3" height="1"></td>
              </tr>
              <tr>
                <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
              ...
              <tr>
                <td height="20"><div align="right"><a href="news/&#26032;&#38395;&#27983;&#35272;.htm"><img src="../images/main_53.gif" width="35" height="9" border="0"></a></div></td>
              </tr>
            </table></td>
          </tr>
        </table>        <br>
        ...
        <table width="95%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td background="../images/desktop_bar_bg.gif"><img src="../images/desktop_bar_left.gif" width="6" height="25" align="absmiddle"><img src="../images/radio_blue.gif" width="13" height="13" align="absmiddle">&nbsp;<font color="#0a66a0"><b>公司新闻</b></font></td>
            <td background="../images/desktop_bar_bg.gif"><div align="right"><img src="../images/desktop_bar_right.gif" width="5" height="25"></div></td>
          </tr>
        </table>        
        <table width="95%" border="0" cellpadding="0" cellspacing="0" class="table_main">
              ...
              <td class="td06"><table width="100%" border="0" cellspacing="4" cellpadding="0">
                  <tr>
                    <td>王小小 先生，您好！<br>
                      ...
                      <br>
                      上次登录时间为：<br>
                      <span class="F01">2006-02-20 14:20:35</span><br>
                      这是您第18次登录本系统</td>
                  </tr>
              </table></td>
...
//  End -->
          ...
          <table width="163" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="50" height="50"><img src="../images/icon_37.gif" width="36" height="36"></td>
              <td><a href="address_list/&#20010;&#20154;&#36890;&#35759;&#24405;&#26597;&#25214;.htm" target="mainFrame" class="a03">个人通讯录</a><br>
              <img src="../images/main_50.gif" width="43" height="9"></td>
            </tr>
          </table>
          <table width="163" border="0" cellspacing="0" cellpadding="0">
            <tr>
          ...
          <table width="163" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="50" height="50"><img src="../images/icon_38.gif" width="36" height="36"></td>
              <td><a href="calendar/&#26085;&#31243;&#23433;&#25490;.htm" class="a03">日程安排</a><br>
              <img src="../images/main_50.gif" width="43" height="9"></td>
            </tr>
    </table>
	      <table width="163" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td width="50" height="50"><img src="../images/icon_38.gif" width="36" height="36"></td>
              <td><a href="../html/PersonalSet/showset.html" class="a03">个人设置</a><br>
                  <img src="../images/main_50.gif" width="43" height="9"></td>
            </tr>
    </table>
	      <table width="163" border="0" cellspacing="0" cellpadding="0">

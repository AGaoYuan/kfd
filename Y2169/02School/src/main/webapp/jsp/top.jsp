...
<form name="form1" method="post" action="">
  <tr>
    ...
    <td class="F02"><img src="../images/person_header.jpg" width="9" height="31" align="absmiddle"> ${uinfo.uname} 先生，您好！ </td>
...
<map name="Map2">
  <area shape="rect" coords="8,6,60,54" href="${pageContext.request.contextPath}/UserInfoServlet?action=logout" target="_parent">
</map>
</body>
</html>

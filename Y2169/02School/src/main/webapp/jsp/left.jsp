  ...
  <tr>
    <td align="center" valign="top" class="td03"><br>
      <table width="90%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="25" class="F01"><p><img src="../images/index_35.gif" width="12" height="16" align="absmiddle"><strong>五道口学院【信息管理系统】</strong></p>
          </td>
        </tr>
        <tr>
                ...
                <td>
					         ...
					         <div id="menu_4" style="DISPLAY: none">
					  					<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td width="19">
															<img id="top_5" onClick="menu('menu_10','top_5');"
																src="../images/tree_11.gif" width="19" height="20">
														</td>
														<td width="19">
												...
												<div id="menu_10" style="DISPLAY: none">
													<table width="100%" border="0" cellspacing="0"
														...
														<tr>
															...
															<td nowrap>
																<a href="work_manage/工作日报.htm" target="mainFrame" class="a03">工作日报</a>
															</td>
														</tr>
													</table>
													<table width="100%" border="0" cellspacing="0"
														...
														<tr>
															...
															<td nowrap>
																<a href="news/xwfb.jsp" target="mainFrame" class="a03">工作月报</a>
															</td>
														</tr>
													</table>
													<table width="100%" border="0" cellspacing="0"
														...
														<tr>
															...
															<td nowrap>
																<a href="news/xwwh.jsp" target="mainFrame"
																	class="a03">工作总结</a>
															</td>
														</tr>
													</table>
					  ...
					  <div id="menu_5" style="DISPLAY: none">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td nowrap><a href="news/栏目管理.htm" target="mainFrame" class="a03">考勤登记</a></td>
						  </tr>
						</table>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
					  ...
					  <div id="menu_2" style="DISPLAY: none">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
							<td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
							<td nowrap><a href="meeting/召开会议.htm" target="mainFrame" class="a03">会议管理</a></td>
						  </tr>
						</table>
					  </div>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
                          <td width="19"><img src="../images/tree_08.gif" width="19" height="20"></td>
                          <td nowrap><a href="calendar/日程安排.htm" target="mainFrame" class="a03">市场相关</a></td>
                        </tr>
                      </table>
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
					  ...
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
							<td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
							<td nowrap><a href="address_list/通讯组管理.htm" target="mainFrame" class="a03">通讯组管理</a></td>
						  </tr>
						</table>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
							<td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
							<td nowrap><a href="address_list/个人通讯录查找.htm" target="mainFrame" class="a03">个人通讯录</a></td>
						  </tr>
						</table>
						<!-- <table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
							<td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
							<td nowrap><a href="address_list/员工通讯录.htm" target="mainFrame" class="a03">员工通讯录</a></td>
						  </tr>
						</table> -->
					  ...
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="19"><img src="../images/tree_06.gif" width="19" height="20"></td>
                          <td width="19"><img id="top_3" onClick="menu('menu_30','top_3');" src="../images/tree_11.gif" width="19" height="20"></td>
                          <td width="19"><img src="../images/tree_08.gif" width="19" height="20"></td>
                          <td nowrap>工作协助</td>
                        </tr>
                      </table>
					  ...
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
							<td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
							<td nowrap><a href="work_manage/共享上传.htm" target="mainFrame" class="a03">共享上传</a></td>
						  </tr>
						</table>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
							<td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
							<td nowrap><a href="work_manage/共享下载.htm" target="mainFrame" class="a03">共享下载</a></td>
						  </tr>
						</table>
						<!-- <table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
                     ...
                     <div id="menu_11" style="DISPLAY: none">
                       <table width="100%" border="0" cellspacing="0" cellpadding="0">
                         <tr>
                           ...
                           <td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
                           <td width="19"><img src="../images/tree_08.gif" width="19" height="20"></td>
                           <td nowrap><a href="bpms/启动流程.htm" target="mainFrame" class="a03">启动流程</a></td>
                         </tr>
                       </table>
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                         <tr>
                           ...
                           <td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
                           <td width="19"><img src="../images/tree_08.gif" width="19" height="20"></td>
                           <td nowrap><a href="bpms/待办事宜.htm" target="mainFrame" class="a03">待办事宜</a></td>
                         </tr>
                       </table>
                       ...
                       <table width="100%" border="0" cellspacing="0" cellpadding="0">
                         <tr>
                           ...
                           <td width="19"><img src="../images/tree_08.gif" width="19" height="20"></td>
                           <td nowrap><a href="bpms/流程监控.htm" target="mainFrame" class="a03">流程监控</a></td>
                         </tr>
                       </table>
                </div>                    
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                     ...
                     <div id="menu_13" style="DISPLAY: none">
                     	 <table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td width="19">
															<img id="top_5" onClick="menu('menu_14','top_5');"
																src="../images/tree_11.gif" width="19" height="20">
														</td>
														<td width="19">
															<img src="../images/tree_08.gif" width="19" height="20">
												...
												<div id="menu_14" style="DISPLAY: none">
													...
													<table width="100%" border="0" cellspacing="0"
														...
														<tr>
															...
															<td nowrap>
																<a href="${pageContext.request.contextPath}/userlist" target="mainFrame" class="a03">用户管理</a>
															</td>
														</tr>
													</table>
												...
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td width="19">
															<img id="top_5" onClick="menu('menu_15','top_5');"
																src="../images/tree_11.gif" width="19" height="20">
														</td>
														<td width="19">
															<img src="../images/tree_08.gif" width="19" height="20">
                       ...
                       <div id="menu_16" style="DISPLAY: none">
                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                             ...
                             <td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
                             <td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
                             <td nowrap><a href="system/popedom/基本权限管理.htm" target="mainFrame" class="a03">基本权限</a></td>
                           </tr>
                         </table>
                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                             ...
                             <td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
                             <td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
                             <td nowrap><a href="system/popedom/角色管理.htm" target="mainFrame" class="a03">角色管理</a></td>
                           </tr>
                         </table>            
                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                             ...
                             <td width="19"><img src="../images/tree_23.gif" width="19" height="20"></td>
                             <td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
                             <td nowrap><a href="system/popedom/用户赋权.htm" target="mainFrame" class="a03">用户赋权</a></td>
                           </tr>
                         </table>
                       </div>
					   ...
					   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                         <tr>
                           <td width="19">&nbsp;</td>
                           <td width="19"><img id="top_17" onClick="bottom('menu_17','top_17');" src="../images/tree_29.gif" width="19" height="20"></td>
                           <td width="19"><img src="../images/tree_08.gif" width="19" height="20"></td>
                           <td nowrap><a href="${pageContext.request.contextPath}/jsp/person_manage/teachassert.jsp" class="a03" target="mainFrame">教员评价</a></td>
                         </tr>
                       </table>
						 <c:if test="${uinfo.ugradeid==0}">
                       <div id="menu_17" style="DISPLAY: none">
                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
						   <tr>
							 ...
							 <td width="19"><img src="../images/tree_23.gif" width="19" height="20"></td>
							 <td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
							 <td nowrap><a href="/UserInfoServlet?action=bindTeacher" target="mainFrame" class="a03">班级-老师绑定</a></td>
						   </tr>
						 </table>						 
                       </div>
						 </c:if>

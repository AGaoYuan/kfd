    ...
    <body>  
		...
		<div id="page-wrapper">
    		<div id="page-inner">
    			...
    			<hr/>
     			<form action="/News/CategoryInfoServlet?action=saveCate" method="post">
	      			<!-- 新闻标题 -->
     				<div>
              			<label for="title">新闻类型名称</label>
                		<input type="text" class="form-control" id="title" name="CateName" placeholder="请输入新闻类型名称" required>
            		</div>
